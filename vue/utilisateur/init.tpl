...
<html>
	...
	<body>
	<ul>
		<li><a href="index.php?controle=client&action=inscription" >Voulez-vous s'incrire ?</a></li>
		<li><a href="index.php?controle=client&action=connexion" >Déjà inscrit comme client ? Se connecter</a></li>
